...
| # | Project | What it proves | Stack | Status |
|---|---|---|---|---|
| 21 | `keyless-ci` | Supply-chain security: OIDC-only pipeline, SHA-pinned actions, cosign + SLSA attestations, tj-actions writeup | GitHub Actions, cosign, Trivy, GHCR | planned |
